...
class Transformer(nn.Module):
    ...
    def forward(
        ...
        hs = self.decoder(tgt, memory, pos_embed=pos_embed, query_pos=query_embed, memory_mask=memory_mask)
        return hs
...
class TransformerEncoderLayer(nn.Module):
    ...
    def forward(
        ...
        if self.normalize_before:
            return self.forward_pre(src, src_mask, src_key_padding_mask, pos_embed)
        return self.forward_post(src, src_mask, src_key_padding_mask, pos_embed)
